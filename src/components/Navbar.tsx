      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-medium tracking-widest uppercase">
            ...
            <Link className="px-6 py-2 border border-neonGreen text-neonGreen hover:bg-neonGreen hover:text-black transition-all duration-300 font-bold shadow-neon" href="#">
              Sign In
            </Link>
          </div>
        </div>
